/**
 * @file ccsds124.h
 * @brief CCSDS 124.0-B-1 Compression Library - Public API
 *
 * @cond INTERNAL
 * ============================================================================
 *  _____                                   ____
 ...
 *
 * This library implements the CCSDS 124.0-B-1 lossless compression algorithm
 ...
 * @{
 */
#define CCSDS124_VERSION_MAJOR 1  /**< Major version number */
#define CCSDS124_VERSION_MINOR 0  /**< Minor version number */
#define CCSDS124_VERSION_PATCH 0  /**< Patch version number */
/** @} */
 ...
 * @{
 */
#define CCSDS124_OK                0   /**< Success */
#define CCSDS124_ERROR_INVALID_ARG -1  /**< Invalid argument */
#define CCSDS124_ERROR_OVERFLOW    -2  /**< Buffer overflow */
#define CCSDS124_ERROR_UNDERFLOW   -3  /**< Buffer underflow */
/** @} */
 ...
 * @{
 */
#define CCSDS124_STATUS_UNGUARANTEED 1  /**< Decompressed successfully but accuracy not guaranteed */
#define CCSDS124_STATUS_TRUNCATED_LENGTH 2 /**< Packet length signaled by a truncated reference packet (weak discovery) */
/** @} */
...
#define CCSDS124_MAX_PACKET_LENGTH 65535U  /**< Maximum packet length in bits (CCSDS max) */
#endif

#define CCSDS124_MAX_PACKET_BYTES (((CCSDS124_MAX_PACKET_LENGTH) + 7U) / 8U)  /**< Max packet bytes */
#define CCSDS124_MAX_ROBUSTNESS 7U     /**< Maximum robustness level (Rₜ) */
#define CCSDS124_MAX_HISTORY 16U       /**< History depth for change vectors */
#define CCSDS124_MAX_VT_HISTORY 16U    /**< History size for Vₜ calculation */
#ifndef CCSDS124_MAX_OUTPUT_BYTES
#define CCSDS124_MAX_OUTPUT_BYTES ((CCSDS124_MAX_PACKET_BYTES) * 12U) /**< Max output buffer size (12× for worst-case RLE expansion) */
#endif
/** @} */
...
typedef struct ccsds124_compressor ccsds124_compressor_t;     /**< Compressor state */
typedef struct ccsds124_decompressor ccsds124_decompressor_t; /**< Decompressor state (planned) */
 ...
 *
 * Populated by ccsds124_decompress_packet_checked() to report whether
 ...
 *
 * Bit vectors are the fundamental data structure for CCSDS 124.0-B-1 compression.
 ...
 */
struct bitvector {
    uint32_t data[((CCSDS124_MAX_PACKET_BYTES) + 3U) / 4U];  /**< 32-bit word storage */
 ...
 * @param[in]  num_bits Number of bits (1 to CCSDS124_MAX_PACKET_LENGTH)
 * @return CCSDS124_OK on success, CCSDS124_ERROR_INVALID_ARG if out of range
 */
 ...
 */
struct bitbuffer {
    uint8_t data[CCSDS124_MAX_OUTPUT_BYTES]; /**< Byte storage */
 ...
 * @return CCSDS124_OK on success, CCSDS124_ERROR_OVERFLOW if full
 */
 ...
 * in CCSDS 124.0-B-1 compressed packets.
 * @{
 */
 ...
 * @return CCSDS124_OK on success
 */
int ccsds124_bit_extract_forward(
    bitbuffer_t *output,
    const bitvector_t *data,
    const bitvector_t *mask
);
 ...
 * Must be initialized with ccsds124_compressor_init() before use.
 */
struct ccsds124_compressor {
    ...
    bitvector_t change_history[CCSDS124_MAX_HISTORY]; /**< Dₜ₋ᵢ: Change vector history */
    size_t history_index;       /**< Current position in circular buffer */
    /** @} */

    /** @name History for cₜ calculation */
    /** @{ */
    uint8_t new_mask_flag_history[CCSDS124_MAX_VT_HISTORY]; /**< ṗₜ history */
 ...
 * management, or 0 to control parameters manually via ccsds124_params_t.
 *
...
/**
 * @brief Counter decoding (inverse of ccsds124_count_encode).
 *
...
/**
 * @brief Run-length decoding (inverse of ccsds124_rle_encode).
 *
...
/**
 * @brief Bit insertion (inverse of ccsds124_bit_extract).
 *
 ...
 * Must be initialized with ccsds124_decompressor_init() before use.
 */
struct ccsds124_decompressor {
    ...
    uint8_t received_status_ring[CCSDS124_MAX_VT_HISTORY]; /**< Status history: 0x00=guaranteed, 0x01=unguaranteed, 0x02=lost */
 ...
 *
 * Like ccsds124_decompress_packet() but additionally tracks mask
 ...
 * @return CCSDS124_OK if guaranteed, CCSDS124_STATUS_UNGUARANTEED if not,
 ...
 * @return CCSDS124_OK on success (check packet_length for result),
 *         CCSDS124_ERROR_INVALID_ARG for NULL pointers or zero bits
 */
