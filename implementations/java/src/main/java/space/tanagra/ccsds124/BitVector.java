 ...
 *
 * <p>This class provides efficient bit manipulation operations for the CCSDS 124.0-B-1 algorithm.
 * Uses MSB-first bit ordering matching the ESA/ESOC reference implementation.
 *
...
public final class BitVector {
  ...
  public BitVector(int numBits) {
    if (numBits < 0 || numBits > Ccsds124.MAX_PACKET_LENGTH) {
